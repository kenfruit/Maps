...
namespace Fusion8.Cropper.Extensibility
{
    ...
    {
        /// <summary>
        /// Gets the plug-in's impementation of the <see cref="BaseConfigurationForm" /> used for setting plug-in specific options.
        /// </summary>
        BaseConfigurationForm ConfigurationForm { get; }

        /// <summary>
        /// Gets a value indicating if the <see cref="ConfigurationForm" /> is to be hosted in the options dialog or shown in its own dialog window.
        /// </summary>
